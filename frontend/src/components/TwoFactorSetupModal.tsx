        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <motion.div
              ...
              className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl border border-gray-100 dark:border-gray-700"
            >
              {/* Close Button */}
                    ...
                    {['initial', 'scan', 'backup'].map((s, i) => (
                      <React.Fragment key={s}>
                        ...
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
                          (s === 'initial' && (step === 'initial' || step === 'scan' || step === 'verify' || step === 'backup' || step === 'complete')) ||
